-- Initial schema for Wandering Inn Tracker
-- Creates all core tables, indexes, views, and functions
...
CREATE TABLE character_classes (
    ...
    evolved_from_class_id INTEGER REFERENCES character_classes(id),
    consolidated_class_ids INTEGER[],
...
CREATE TABLE character_abilities (
    ...
    chapter_id INTEGER NOT NULL REFERENCES chapters(id) ON DELETE CASCADE,
    character_class_id INTEGER REFERENCES character_classes(id),
    level_at_acquisition INTEGER,
    raw_event_id INTEGER REFERENCES raw_events(id),
    acquisition_method VARCHAR(50) DEFAULT 'level_up',
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
